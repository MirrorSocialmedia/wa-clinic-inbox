...
// ★ cwi-auditfix-20260908（H-1）：pure 核心拆入 lexicon-core（client-safe）— 此處 re-export 保持舊 import 點唔變
export { applyLexicon, lexiconPromptBlock } from "./lexicon-core";
export type { LexiconEntry } from "./lexicon-core";
...
// applyLexicon / lexiconPromptBlock → 見 ./lexicon-core（此檔頂部 re-export）
